...
def test_linked_list():
    ...
    ll.insert(node_6, 3)
    ll.insert(node_7, 4)
    assert ll.to_string() == '2 -> 99 -> 24 -> -4.5 -> 100000 -> -31 -> 0 -> '
    ...
    # test delete()
    ll.delete(99)
    assert ll.to_string() == '2 -> 24 -> -4.5 -> 100000 -> -31 -> 0 -> '
    ll.delete(0)
    ll.delete(2)
    ll.delete(24)
    assert ll.to_string() == '-4.5 -> 100000 -> -31 -> '
    node_8 = Node(-31)
    ll.insert(node_8, 1)
    assert ll.to_string() == '-4.5 -> -31 -> 100000 -> -31 -> '
    ...
    assert ll.to_string() == '-4.5 -> 100000 -> -31 -> '
    ll.delete(-31)
    assert ll.to_string() == '-4.5 -> 100000 -> '
    ll.delete(-4.5)
    assert ll.to_string() == '100000 -> '
    ll.delete(100000)
    assert ll.to_string() == ''
